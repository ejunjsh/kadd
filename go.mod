...
require (
	...
	github.com/aylei/kubectl-debug v0.1.1
	github.com/docker/distribution v2.7.1-0.20190205005809-0d3efadf0154+incompatible // indirect; 2020-04-15 d : https://github.com/containerd/containerd/issues/3031
